...
//                phân quyền ở đây
                if(AD.equals(roleID)){
                    url= ADMIN_PAGE;
                    logger.info("Da dang nhap duoi quyen admin '{}'", userID);
                }else if(US.equals(roleID)){
                    url= USER_PAGE;
                    logger.info("Da dang nhap duoi quyen user '{}'",userID);
                }else{
                    request.setAttribute("ERROR", NOT_SUPPORT_MESSAGE);
                    logger.warn("Quyen dang nhap ben ngoai AD, US '{}'", userID);
                }
            }else{
                request.setAttribute("ERROR", INCORRECT_MESSAGE);
                logger.warn("Nhap sai password '{}'", userID);
            }
